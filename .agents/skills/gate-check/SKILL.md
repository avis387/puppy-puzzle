...
- [ ] Art bible exists at `design/art/art-bible.md` with at least Sections 1?? (Visual Identity Foundation)
...
A depends on B). If any cycle is detected (e.g. A??, or A???):
...
- If any answer reveals a missed blocker ??upgrade verdict (PASS?ONCERNS or CONCERNS?AIL)
